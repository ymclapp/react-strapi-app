                    ...
                    <Row xs={1} md={4} className="g-4">
                        {books.results.books?.map((book) =>
                            <Col>
                                <Card key={book.id}>
                                    <Card.Header
                                        className='book-header text-center'
                                    >
                                        <h3>{book.title}</h3>
                                        <h5 className='text-muted'>{book.contributor}</h5>
                                    </Card.Header>
                                    <Card.Body className='book-abstract text-justify'>
                                        <h5>{book.description}</h5>
                                        <Card.Img className='book-image' variant='bottom' src={book.book_image} />
                                    </Card.Body>
                                    <Card.Footer className='book-footer text-muted text-center'>
